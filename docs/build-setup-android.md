...
如果配置过程有不明白，可以查看 [样本工程](https://github.com/little-snow-fox/react-native-wechat-open-sdk/tree/master/example)
在样本工程里搜索 '**react-native-wechat-open-sdk support**' 便可以找到所有需要添加配置的地方
